...
export const NAV_ITEMS: readonly NavItem[] = [
  ...
  },
  {
    ...
    group: "work",
    Icon: CalendarIcon,
    tooltip: "Scheduled cron-like workflows across repositories.",
  ...
  },
  {
    ...
    group: "fleet",
    Icon: ScrollTextIcon,
    tooltip: "Durable fleet event history + alarm center.",
    tabId: "events",
    frequent: false,
    mobilePrimary: false,
    mobileDrawer: true,
  ...
  },
  {
    ...
    group: "fleet",
    Icon: ConductorIcon,
    tooltip: "Conductor orchestrator: plan generation and execution.",
    tabId: "conductor",
    frequent: true,
    mobilePrimary: false,
    mobileDrawer: true,
