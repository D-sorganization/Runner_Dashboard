...
import { RemediationPRsSubTab } from "../pages/RemediationPRs"
import { RemediationIssuesSubTab } from "../pages/RemediationIssues"
...
function RemediationTab(p) {
  ...
  return h(
          ...
          : failedRuns.map(function (run) {
              ...
              return h(
                ...
                (function() {
                  ...
                  var modelOpts = PROVIDER_MODELS[currentProvider];
    ...
    subTab === "prs" && h(RemediationPRsSubTab, { principalName: p.principalName }),
    subTab === "issues" && h(RemediationIssuesSubTab, { principalName: p.principalName }),
  );
}
