...
| ---------- | ---------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-09-25 | #1492                  | SC-B1-G9: Chat pool saturation answers busy, not run anyway. When every slot is taken in `ChatConcurrencyPool`, slot acquisition waits up to `STAFF_CHAT_ACQUIRE_TIMEOUT_SECONDS` (default 1.0s) via `ChatConcurrencyPool.acquire(role, timeout)` before marking the reply placeholder failed with `failure_class="chat_capacity"`, posting a system busy notice ("All chat slots are busy. Please retry shortly."), publishing live SSE events to `ThreadEventBus`, recording an audit event (`action="chat_capacity"`, `outcome="busy"`), and returning `ChatTurnResult(ok=False, failure_class="chat_capacity", retryable=True)` without spawning CLI processes or exceeding pool limits. Fixed Barb slot reservation calculation for pool size 1 (`min(max(0, barb_reserved), self.max_concurrency)`). Added unit test suite in `tests/unit/test_staff_chat_capacity.py`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
