...
| ---------- | ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-09-25 | #1317                  | SC-D3: Staff roster sidebar: grouped roles into 4 operational tiers (Leadership, Project Managers, Specialists, Operations), top entry Ask Barb (auto-route), 5 lifecycle status dots (idle, working, needs you, unavailable, invalid) with descriptive tooltip reasons, unread badges and last-message previews with relative timestamps, real-time search filtering across name/title/mandate, server-side persistent pinning (`GET/POST/DELETE/PUT /api/v1/staff/pins`) with localStorage fallback, keyboard navigation (ArrowDown, ArrowUp, Enter, Home, End, Escape), and visible stale roster indicators with retry on fetch failure.                                                                                                                     |
