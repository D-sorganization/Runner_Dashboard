...
| ---------- | ---------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-09-25 | #1340                  | SC-C7: Barb routing evaluation set and regression check. 60 labelled cases ship in `backend/staff/routing_eval_cases.json`; `staff.routing_eval` scores the deterministic pre-router (CI gate: every case passes) and the full two-stage router (refreshed daily by `routing_eval_loop` at startup, persisted to `routing_eval_latest.json`); `GET /api/staff/routing/eval`; typed `RoutingEvalSummary` on `StaffBoardResponse.routing_eval` rendered as a Board badge; `scripts/eval_barb_routing.py` CLI (threshold 1.0).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
