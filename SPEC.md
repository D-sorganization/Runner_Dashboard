...
| 2026-09-26 | #1584 | Fix test hermeticity when proxy_utils is unavailable: handle ImportError in \_no_hub_proxy in tests/conftest.py when running lightweight test targets without backend web dependencies. |
