...
| ---------- | ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-09-25 | #1318                  | SC-D4: Thread view and composer: streaming markdown, @mentions, slash commands, reliable send. Implemented `ThreadView`, `Composer`, `MessageItem`, and `markdownRenderer` components in `frontend/src/pages/StaffConsole/`. Features auto-resizing composer textarea with draft persistence in `localStorage`, @mention autocompletion for roles, slash command templates (`/dispatch`, `/review`, `/status`, `/hold`, `/brief`), voice input trigger, message bubble alignment (user right, role left, system center), sanitized Markdown rendering with code block copy buttons and entity chips, date separators, SSE reconnecting status, streaming typing indicator with stop button, and idempotency key preserved retries.                              |
