...
| ---------- | ---------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-09-25 | #1498                  | SC-G5-2: One Advanced dispatch form (replaces Staff Assign and the Fleet Command Dispatch tab). Built unified `AdvancedDispatchForm` component posting to the work-request API (`POST /api/v1/staff/requests`) supporting kinds `staff.dispatch`, `ci.remediate`, `issue.act`, `pr.act`, `code_request.dispatch`, `assessment.run`; dynamically adapts visible target fields based on kind; supports peer-node forwarding, dry-run preview with plan rendering, Idempotency-Key protection, classified server error preservation; replaced legacy `Assign.tsx` and updated `DispatchPanel.tsx` (preserving Staff tab run link) and `StaffPage.tsx`; zero remaining imports of old Assign form; full quality gates passed. |
