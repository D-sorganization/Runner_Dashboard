...
| ---------- | ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-09-25 | #1328                  | SC-C5: "Waiting on you" inbox and Barb briefings inside the dashboard. Aggregated waiting items across 6 sources (approvals awaiting decision, needs-input run questions, escalated work items, pending project decisions, unvoted board proposals, missing CLI auth logins) into unified inbox endpoint GET /api/v1/staff/inbox with source degradation and caching. Scheduled Barb morning/midday/evening briefings to conversation threads with on-demand /brief slash command and POST /api/v1/staff/briefing endpoint. Push notifications strictly for critical escalations with deep links. Interactive frontend InboxPanel in Staff Console with category filters, badge counts, copyable auth sign-in commands, and /brief trigger.                     |
