...
| ---------- | ---------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-09-25 | #1500 | SC-G5-4: Remediation Issues and PRs bulk actions go through the request API. Switch RemediationIssues and RemediationPRs from `/api/issues/dispatch` and `/api/prs/dispatch` to `POST /api/v1/staff/requests` with kinds `issue.act` and `pr.act`, passing bulk targets (`issues` and `prs`), provider, prompt, force, and approved_by. Single WorkItem created per bulk request linking all targets. Failures and partial backend dispatch reported per target in inline status banner, keeping un-dispatched items selected. |
