...
from routers import staff_pins as _staff_pins_router  # noqa: E402
...
app.include_router(_staff_pins_router.router, prefix="/api/v1/staff")  # Staff role pins persistence (issue #1317)
