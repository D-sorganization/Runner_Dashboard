...
from routers import staff_maintenance as _staff_maintenance_router  # noqa: E402
...
app.include_router(_staff_maintenance_router.router, prefix="/api/v1/staff")  # Maintenance API (issue #1322)
