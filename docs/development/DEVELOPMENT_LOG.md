...
- **Started:** 2026-09-26
- **Last verified:** 2026-09-26 (`a117f377` baseline; test_staff_review 28 passed, 8 new RED→GREEN incl. concurrent dedupe; full suite same 9 environment-only failures before and after)
